"""Job for executing the implicit recommender notebook."""
...
class RunImplicitRecommenderJob:
    """Execute `07_implicit_recommender.ipynb` via nbconvert."""

    def __init__(
        self,
        notebook_path: str | Path = "data_mining/07_implicit_recommender.ipynb",
