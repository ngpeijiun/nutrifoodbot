"""Job for executing the dataset foundation analysis notebook."""
...
class RunDatasetFoundationAnalysisJob:
    """Execute `01_dataset_foundation_analysis.ipynb` via nbconvert."""

    def __init__(
        self,
        notebook_path: str | Path = "data_mining/01_dataset_foundation_analysis.ipynb",
...
if __name__ == "__main__":
    job = RunDatasetFoundationAnalysisJob()
    job.run()
