"""Job for executing the synthetic feedback data notebook."""
...
class RunSyntheticFeedbackDataJob:
    """Execute `05_synthetic_feedback_data.ipynb` via nbconvert."""

    def __init__(
        self,
        notebook_path: str | Path = "data_mining/05_synthetic_feedback_data.ipynb",
...
if __name__ == "__main__":
    job = RunSyntheticFeedbackDataJob()
    job.run()
