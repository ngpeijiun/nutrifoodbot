"""Job for executing the food classification analysis notebook."""
...
class RunFoodClassificationAnalysisJob:
    """Execute `04_food_classification_analysis.ipynb` via nbconvert."""

    def __init__(
        self,
        notebook_path: str | Path = "data_mining/04_food_classification_analysis.ipynb",
...
if __name__ == "__main__":
    job = RunFoodClassificationAnalysisJob()
    job.run()
